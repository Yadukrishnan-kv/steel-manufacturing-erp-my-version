 ...
 * A comprehensive button component with multiple variants and full Material-UI compatibility
 */
 ...
 * Maintains full compatibility with existing Material-UI button functionality while
 * providing modern, Procore-inspired styling.
 * 
 * @param variant - Button style variant (primary, secondary, tertiary, ghost, danger)
 ...
 * @param startIcon - Icon to display at the start of the button
 * @param endIcon - Icon to display at the end of the button
